...
module_param(crp_key, charp, 0000);
MODULE_PARM_DESC(crp_key, "Key String for AES-CBC");
module_param(crp_iv, charp, 0000);
MODULE_PARM_DESC(crp_iv, "Initialization Vector for AES-CBC");
